...
import com.apps.bacon.mydiabetes.ui.change.meal.name.ChangeMealNameActivity
...
class MealActivity : BaseActivity(), ProductsAdapter.OnProductClickListener,
    ...
    private fun dialogDeleteMeal() {
        ...
        dialogBinding.deleteButton.setOnClickListener {
            ...
            mealViewModel.getImageByMealId(meal.id).observe(this, {
                for (img in it) {
                    mealViewModel.deleteImage(img)
                }
            })
    ...
    private fun dialogImageManager(image: Image) {
        ...
        dialogBinding.deleteButton.setOnClickListener {
            ...
            mealViewModel.deleteImage(image)
