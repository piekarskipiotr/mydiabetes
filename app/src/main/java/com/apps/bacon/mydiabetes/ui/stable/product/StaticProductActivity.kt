...
class StaticProductActivity : BaseActivity() {
    ...
    private val staticProductViewModel: StaticProductViewModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        staticProduct = staticProductViewModel.getProduct(productId)

        initRecyclerView()
        setProductInfo()

        staticProductViewModel.getURL(storageReference, "product", staticProduct.name)?.observe(this, {
        ...
        if (staticProduct.inFoodPlate) {
            ...
            binding.addButton.setOnClickListener {
                staticProductViewModel.updateProduct(staticProduct.apply {
                    inFoodPlate = true
                })
                binding.addButton.isClickable = false
                binding.addButton.alpha = 0.8f
    ...
    private fun setProductInfo() {
        ...
        if (staticProduct.tag == null)
            ...
            val tag = staticProductViewModel.getTagById(staticProduct.tag!!)
