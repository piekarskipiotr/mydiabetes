...
class StaticFoodPlateAdapter constructor(
    private val listener: OnProductClickListener
) : RecyclerView.Adapter<StaticFoodPlateAdapter.ViewHolder>() {
    ...
    fun getData(): List<StaticProduct> {
        return data
    }
    ...
    fun getProduct(position: Int): StaticProduct {
