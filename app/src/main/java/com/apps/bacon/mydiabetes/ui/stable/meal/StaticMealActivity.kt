...
class StaticMealActivity : BaseActivity(), ProductsAdapter.OnProductClickListener {
    ...
    private val staticMealViewModel: StaticMealViewModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        staticMeal = staticMealViewModel.getMeal(mealId)
        ...
        staticMealViewModel.getURL(storageReference, "meal", staticMeal.name)?.observe(this, {
    ...
    private fun setMealInfo() {
        ...
        staticMealViewModel.getProductsForMeal(staticMeal.name).observe(this, {
