...
import com.apps.bacon.mydiabetes.ui.add.product.AddProductFragment
import com.apps.bacon.mydiabetes.ui.foodplate.FoodPlateActivity
import com.apps.bacon.mydiabetes.ui.meals.MealsFragment
import com.apps.bacon.mydiabetes.ui.search.SearchActivity
import com.apps.bacon.mydiabetes.ui.settings.SettingsFragment
...
class HomeActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        homeViewModel.getAll().observe(this, {
            addTabs(it)
        })

        homeViewModel.getProductsInPlate().observe(this, {
            if (it.isEmpty()) {
    ...
    override fun onStart() {
        ...
        if (isActivityAfterLangChange) {
            ...
            homeViewModel.translateTags(
                listOf(
                    getString(R.string.meat),
                    getString(R.string.fish),
                    getString(R.string.protein),
                    getString(R.string.bread),
                    getString(R.string.vegetables_and_fruits),
                    getString(R.string.sweets_and_snacks),
                    getString(R.string.drinks),
                    getString(R.string.nuts),
