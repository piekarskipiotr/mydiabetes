...
class Calculations {
    ...
    fun carbohydrateExchangesByWeight(
        carbohydrateExchanges: Double,
        weight: Double,
        correctWeight: Double
    ): Double {
        return roundToOneDecimal((carbohydrateExchanges * correctWeight) / weight)
    }

    fun proteinFatExchangersByWeight(
    ...
    fun carbohydrateExchangesByPieces(
        carbohydrateExchanges: Double,
        pieces: Int,
        correctPieces: Int
    ): Double {
    ...
    fun proteinFatExchangersByPieces(
        proteinFatExchangers: Double,
        pieces: Int,
        correctPieces: Int
    ): Double {
